...
const en = {
  ...
  common: {
    ...
    inquiryTypes: ['General Inquiry', 'Spiritual Guidance', 'Visit Planning', 'Event Information', 'Donation / Support', 'Other'],
    call: 'Call',
    whatsApp: 'WhatsApp',
  },
};
...
const ur = {
  ...
  common: {
    ...
    inquiryTypes: ['عمومی استفسار', 'روحانی رہنمائی', 'دورے کی منصوبہ بندی', 'تقریب کی معلومات', 'عطیہ / تعاون', 'دیگر'],
    call: 'کال کریں',
    whatsApp: 'واٹس ایپ',
  },
};
...
const ar = {
  ...
  common: {
    ...
    inquiryTypes: ['استفسار عام', 'إرشاد روحاني', 'تخطيط زيارة', 'معلومات الفعاليات', 'تبرع / دعم', 'آخرى'],
    call: 'اتصال',
    whatsApp: 'واتساب',
  },
};
...
const hi = {
  ...
  common: {
    ...
    inquiryTypes: ['सामान्य पूछताछ', 'आध्यात्मिक मार्गदर्शन', 'यात्रा योजना', 'कार्यक्रम जानकारी', 'दान / समर्थन', 'अन्य'],
    call: 'कॉल करें',
    whatsApp: 'व्हाट्सएप',
  },
};
